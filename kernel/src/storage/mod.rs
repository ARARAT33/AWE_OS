...
impl From<GptError> for StorageError {
    fn from(error: GptError) -> Self {
        match error {
            ...
            | GptError::TooManyPartitions | GptError::InvalidPartitionRange
            | GptError::HeaderCrcMismatch | GptError::PartitionArrayCrcMismatch
            | GptError::BadSignature | GptError::UnsupportedRevision => Self::InvalidMetadata,
        }
    }
}
