...
pub use pci_virtio_probe::{ProbeError as VirtioProbeError,VirtioDeviceKind,VirtioPciProbe,MAX_VIRTIO_PROBES};
...
pub use virtio_block::{BlockCompletion,BlockError,BlockOp,BlockRequest,VirtioBlockConfig,VirtioBlockQueue,MAX_REQUEST_SECTORS,SECTOR_SIZE};
