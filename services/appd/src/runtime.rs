use super::{validate_manifest, AppId, AppManifest, AppState};
...
mod tests {
    ...
    fn manifest(id: u64) -> AppManifest { AppManifest { id: AppId(id), abi_major: 1, abi_minor: 3, memory_limit_pages: 4, capability_mask: 0b101, dependency_count: 0, resource_count: 0 } }
