...
pub use asd::{
    ...
    ASD_MAX_MANIFEST, ASD_MAX_PAYLOAD, ASD_MIN_SIGNATURE, ASD_VERSION, DRIVER_ABI_MAJOR,
    DRIVER_ABI_MINOR, DRV_CAP_DMA, DRV_CAP_IRQ, DRV_CAP_MMIO, DRV_CAP_PORT_IO, AsdError, AsdHeader,
